...
- ex) a 'teacher' positions has certain rights and responsibilities relative to actors playing the 'student' positions

## Role Analysis with Blockmodel
- All actors fall into a position(here, cluster)
- We call it as a block
- create a matrix based on the relationship btw the blocks
