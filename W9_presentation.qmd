...
- Form a matrix where the positions themselves are the nodes, or blocks
- All actors the last cluster (node 1, 9, 10, 12 and 15 in the figure above) fall into a single block...
- Analyze the resulting blockmodel in terms of the pattern of ties between blocks. 
