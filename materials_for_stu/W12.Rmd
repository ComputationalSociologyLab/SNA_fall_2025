...
control=control.ergm(MCMC.burnin=25000,        # These control options are not needed if the model works.                                  MCMC.samplesize=5000,                                  parallel=ncores,                                  parallel.type="PSOCK",                                  MCMLE.density.guard = exp(5)) 
