---
title: "W10. Affiliations, Fields, and Space"
format: 
  revealjs:
    theme: default
    slide-number: true
...
# Affiliations, Fields, and Space
- Walks through the analysis of affiliation data
  - e.g., student - student extracurricular affiliations 
  - two styles of node (one node for students, the other node for clubs)
  - two-mode network!
...
- Objectives) Analyze the texts in abstract to uncover the underlying structure of the field of sociology,
  - Two styles of node (one mode for the words in abstract, the other mode for topic of abstract)
  - topic, theme ... Apply topic modeling (😁😁😁😁😁😁😁)
...
- RQ) How students in different departments belong to different topics? Which topics are 'close' to which other topics?
  - Add on the department information of students who submitted a dissertation
...
## Identify Space with Correspondence Analysis 
- `fviz_ca_biplot()` give us the visualization of Correspondence Analysis
